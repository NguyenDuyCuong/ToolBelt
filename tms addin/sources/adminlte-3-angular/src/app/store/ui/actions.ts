...
export const TOGGLE_WORKING_CALENDAR_MODE: string = 'TOGGLE_WORKING_CALENDAR_MODE';
...
export class ToggleWorkingCalendarMode implements Action {
    readonly type: string = TOGGLE_WORKING_CALENDAR_MODE;
    constructor(public payload?: string) {}
}
